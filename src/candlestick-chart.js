/**
 ...
 A candlestick chart combines a line chart and a bar chart in order to communicate asset
 price changes over time.

 #### dc.candlestickChart(parent[, chartGroup])
 Create a candlestick chart instance and attach it to the given parent element.
 ...
 * chartGroup : string (optional) - name of the chart group this chart instance should be placed in. Once a chart is placed
 ...
 Return:
 A newly created candlestick chart instance

 ```js
 // create a candlestick chart under #chart-container1 element using the default global chart group
 var candlestickChart1 = dc.candlestickChart("#chart-container1");
 // create a candlestick chart under #chart-container2 element using chart group A
 var candlestickChart2 = dc.candlestickChart("#chart-container2", "chartGroupA");
 ```

 **/
dc.candlestickChart = function (parent, chartGroup) {
    ...
    **/
    ...
    /**
     ...
     Get or set the numerical width of the candlestick box. Provided width may also be a function.
